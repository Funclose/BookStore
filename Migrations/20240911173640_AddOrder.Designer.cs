...
namespace BooksStore.Migrations
{
    ...
    [Migration("20240911173640_AddOrder")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BooksStore.Models.OrderLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BooksStore.Models.Promotion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AuthorBook", b =>
                {
                    b.HasOne("BooksStore.Models.Author", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BooksStore.Models.Promotion", b =>
                {
                    b.HasOne("BooksStore.Models.Book", "Book")
                        .WithOne("Promotion")
                        .HasForeignKey("BooksStore.Models.Promotion", "BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
